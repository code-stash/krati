 ...
 * @since 09/25, 2011
 */
public class BasicArrayStoreResponder extends StoreResponder {
    
    public BasicArrayStoreResponder(ArrayStore store) {
        super(new BasicArrayStoreProtocolHandler(store));
    }
